            ...
            <div className="row">
                  ...
                  {categoryList.length ? (
                    ...
                    <li  key={index}> <a href="/danh-sach" className="tieude"> {value.name}</a><i className="fa fa-chevron-right icon float-right" />
                      ...
                      {value.subCate.length ? (
                          ...
                          <li className="liheader1"><a href="/danh-sach" className="header text-uppercase"> {value.name}
                          </a></li>
              ...
              <div className="col-md-9 px-0"width="965px" >
                <div id="carouselId" className="carousel slide" data-ride="carousel">
                  ...
                  <div className="carousel-inner"width="965px" style={{marginTop:'-40px'}} >
                    <div className="carousel-item active"width="965px" >
                      <a href="#"><img src="images/banner-sach-moi.jpg" className="img-fluid" style={{height: '427px'}} width="965px" alt="First slide" /></a>
                    </div>
                    <div className="carousel-item"width="965px">
                      <a href="#"><img src="images/banner-beethoven.jpg" className="img-fluid" style={{height: '427px'}} width="965px" alt="Second slide" /></a>
                    </div>
                    <div className="carousel-item"width="965px">
                      <a href="#"><img src="images/neu-toi-biet-duoc-khi-20-full-banner.jpg" className="img-fluid" style={{height: '427px'}} width="965px" alt="Third slide" /></a>
                    </div>
                  </div>
