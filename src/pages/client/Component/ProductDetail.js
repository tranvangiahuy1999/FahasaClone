                  ...
                  <div className="row">
                    ...
                    <div className="col-md-7 price">
                      <div className="gia">
                        ...
                        <div className="giaban">Giá bán tại DealBooks:

                          {
                            value.parameters
                              ...
                              .map((value, index) => (
                                ...
                                <span className="giamoi font-weight-bold">{defaultPrice.price}₫</span>
                        ...
                        <div className="danhsach" style={{ marginRight: '2px' }}>
                          ...
                          {value.parameters.map((value, index) => {
                            ...
                            if (value._id === defaultPrice._id) {
                              return (
                                <button style={{ background: '#198754', color: 'white' }} type="button" onClick={() => setDefaultPrice({
                                  "price": value.price,
                                  "_id": value._id
                                })} className="btn btn-outline-success">{value.name}</button>
                              )
                            }
                            else {
                              return (
                                <button type="button" onClick={() => setDefaultPrice({
                                  "price": value.price,
                                  "_id": value._id
                                })} className="btn btn-outline-success">{value.name}</button>
                              )
                ...
                {productDetail.map((value, index) => (
                  ...
                  <div className="tab-content" id="nav-tabContent">
                    <div className="tab-pane fade show active ml-3 " id="nav-gioithieu" role="tabpanel" aria-labelledby="nav-gioithieu-tab">
                      <div className="row">
                        <h3 style={{ marginTop: '5px', marginBottom: '-15px' }}>Chi Tiết Sản Phẩm</h3>
                        <div className="col-md-5 mt-4 giua ">
                          ...
                          <div className="tonggiatien">
                            ...
                            <div className="details">
                              {Object.values(value.details).map((value, index) => (
