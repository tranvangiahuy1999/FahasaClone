  ...
  return (
    <div className="all">
                  ...
                  <div>
                    {value._id === params.id ? (
                      <li className="breadcrumb-item active">
                        <a style={{ paddingLeft: "10px", color: "orange" }}>
                          <span
                    ...
                    {value._id === productId1 ? (
                      <li className="breadcrumb-item phu">
                        <a style={{ paddingLeft: "25px", color: "black" }}>
                          {value.name}
                        </a>
                      </li>
                    ) : (
      ...
      >
        <div className="container text-center">
          <a href="sach-moi-tuyen-chon.html">
            <img
              src="/images/banner-sach-ktkn.jpg"
              alt="banner-sach-ktkn"
              className="img-fluid"
            />
          </a>
        </div>
      ...
      <section className="content my-4" style={{ background: "#F0F0F0" }}>
        <div
          className="container contentList"
          style={{ marginTop: "-24px", width: "81%", marginBottom: "3%" }}
        >
            ...
            <div className="row" style={{ background: "#F0F0F0" }}>
              ...
              >
                ...
                >
                  ...
                  <h3 style={{ fontSize: "17px", marginLeft: "13px" }}>
                    Tất Cả Sản Phẩm
                  </h3>
                  <ul>
                    {categoryList.length ? (
      ...
      <section
        ...
        style={{ background: "#F0F0F0", marginTop: "-3%" }}
      >
        <div
          className="container nearbottom"
