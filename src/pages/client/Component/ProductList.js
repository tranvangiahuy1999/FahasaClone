...
const ProductList = () => {  
  ...
  return (
    <Switch>
      <Route path={`${match.path}/:slug.:id`} component={ProductListContent} />
      <Route path={`${match.path}/:slug1/:slug.:id`} component={ProductListContent} />
      <Route path={`${match.path}/:slug1/:slug2/:slug.:id`} component={ProductListContent} />
      <Route path={`${match.path}/:slug1/:slug2/:slug3/:slug.:id`} component={ProductListContent} />
      <Route path={`${match.path}/:slug1/:slug2/:slug3/:slug4/:slug.:id`} component={ProductListContent} />
    </Switch>
  )
}
