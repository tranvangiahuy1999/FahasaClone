        ...
        <div className="container">
          <ol className="breadcrumb mb-0 p-0 bg-transparent">
            ...
            <li className="breadcrumb-item">
              <a href="#">Kết quả tìm kiếm : {params.name}</a>
            </li>         
          </ol>
        </div>
      </section>
        ...
        <div className="container contentList" style={{ marginTop: '-24px', width: '81%',marginBottom:'3%' }}>
          <div className="noidung bg-white" >
            ...
            <div className="row" style={{ background: '#F0F0F0' }}>
              ...
              <div className="col-md-12 col-xs-12" style={{ background: 'white' }}>
                ...
                <h3 style={{textAlign:'center',marginTop:'3%'}}>Không Thể Tìm Thấy Sản Phẩm</h3>
                }
