            ...
            <section className="content my-3">
              <div className="container">
                <div className="cart-page bg-white">
                    ...
                    <div className="col-12 cart-empty d-none">
                      <div className="py-3 pl-3">
                        ...
                        <div className="cart-empty-content w-100 text-center justify-content-center">
                          ...
                          <a href="/" className="btn nutmuathem mb-3">Mua thêm</a>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* het row  */}
                  <a href="/thanh-toan" className="col-md-4"><button type="button" className="btn btn-success receiptbtn mt-2">Thanh Toán</button></a>
                </div>
                {/* het cart-page  */}
